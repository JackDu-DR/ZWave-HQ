...
{
    [Guid("D1A1FB3C-B57F-4516-9387-C1EF1D9F415F")]
    [ClassInterface(ClassInterfaceType.None)]
    [ComVisible(true)]
    public class DonorLiftingModuleConfigurationDTO : BaseDTO, IDonorLiftingModuleConfigurationDTO
    {
        ...
        {
            var newObject = JsonConvert.DeserializeObject<DonorLiftingModuleConfigurationDTO>(json);
