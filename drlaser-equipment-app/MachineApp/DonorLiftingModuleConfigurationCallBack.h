...
class DonorLiftingModuleConfigurationCallBack
{
public:
	DonorLiftingModuleConfigurationCallBack(RPCQueueHandler* handler, IMasterPtr master, IMachineMessageHandlerPtr machineAMQPHandler);
