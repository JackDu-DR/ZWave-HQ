...
class MotionAxisControlConfigurationCallBack
{
public:
	MotionAxisControlConfigurationCallBack(RPCQueueHandler* handler, IMasterPtr master, IMachineMessageHandlerPtr machineAMQPHandler);
